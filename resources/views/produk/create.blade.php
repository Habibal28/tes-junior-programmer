...
<div class="mb-6">
    <div class="flex items-center text-sm text-slate-500 mb-2">
        <a href="{{ route('produk.index') }}" class="hover:text-primary">Manajemen Produk</a>
        <span class="mx-2">/</span>
        <span class="text-slate-900 font-semibold">Tambah Produk</span>
    </div>
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 max-w-3xl">
    ...
    <form action="{{ route('produk.store') }}" method="POST" class="p-8 space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="nama_produk" value="{{ old('nama_produk') }}" class="w-full h-11 rounded-lg border border-slate-300 px-4
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <input type="number" name="harga" value="{{ old('harga') }}" class="w-full h-11 rounded-r-lg border border-slate-300 px-4
                                  focus:ring-2 focus:ring-primary/20 focus:border-primary
        ...
        <div>
            ...
            <select name="status_id" class="w-full h-11 rounded-lg border border-slate-300 px-4
                ...
                <option value="{{ $item->id_status }}" {{ old('status_id')==$item->id_status ? 'selected' : '' }}>
